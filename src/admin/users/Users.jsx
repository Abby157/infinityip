            ...
            <div style={{ display: 'flex', flexDirection: 'column', gap: '7px' }}>
              {filtered.map(user => {
                ...
                return (
                  <div
                    key={user.id}
                    onClick={() => { setSelected(isSel ? null : user); setWalletAmt(''); setNotifMsg('') }}
                    style={{
                  ...
                  >
                    ...
                    <div style={{ flex: 1, minWidth: '130px' }}>
                      <div style={{ display: 'flex', alignItems: 'center', gap: '6px', marginBottom: '2px' }}>
                        ...
                        {isAdminUser && (
                          <span style={{ background: '#f59e0b18', border: '1px solid #f59e0b44', borderRadius: '20px', padding: '1px 6px', color: '#fbbf24', fontSize: '9px', fontWeight: 700 }}>ADMIN</span>
                        )}
                        {user.suspended && (
                          <span style={{ background: '#ef444418', border: '1px solid #ef444433', borderRadius: '20px', padding: '1px 6px', color: '#f87171', fontSize: '9px', fontWeight: 700 }}>SUSPENDED</span>
                        )}
                      </div>
          ...
          <div style={{ background: 'linear-gradient(145deg,#13131f,#0d0d18)', border: '1px solid #6366f122', borderRadius: '16px', padding: '18px', position: 'sticky', top: '20px' }}>
            ...
            <div style={{ textAlign: 'center', marginBottom: '16px' }}>
              <div style={{
                ...
                background: selected.email === ADMIN_EMAIL
                  ? 'linear-gradient(135deg,#f59e0b,#d97706)'
                  : 'linear-gradient(135deg,#6366f1,#8b5cf6)',
                display: 'flex', alignItems: 'center', justifyContent: 'center',
            ...
            {selected.email !== ADMIN_EMAIL && (
              <button onClick={() => toggleSuspend(selected)} disabled={acting} style={{
                width: '100%',
                background: selected.suspended ? '#22c55e18' : '#ef444418',
                border: `1px solid ${selected.suspended ? '#22c55e33' : '#ef444433'}`,
                color: selected.suspended ? '#4ade80' : '#f87171',
                borderRadius: '8px', padding: '9px', cursor: acting ? 'not-allowed' : 'pointer',
